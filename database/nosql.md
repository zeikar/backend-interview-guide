...
- [NoSQL 데이터베이스](#nosql-데이터베이스)
  ...
  - [장점](#장점)
  - [단점](#단점)
- [NoSQL과 관계형 데이터베이스의 차이점](#nosql과-관계형-데이터베이스의-차이점)
  - [데이터 모델링](#데이터-모델링)
  - [스케일링(Scaling)](#스케일링scaling)
  - [ACID vs. BASE](#acid-vs-base)
  - [사용 사례](#사용-사례-1)
- [NoSQL의 주요 데이터베이스 유형](#nosql의-주요-데이터베이스-유형)
...
- [CAP 이론과 NoSQL](#cap-이론과-nosql)
  - [CAP 이론의 적용](#cap-이론의-적용)
- [NoSQL에서 스케일링(Scaling)](#nosql에서-스케일링scaling)
