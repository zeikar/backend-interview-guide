...
이 문서는 **저장소 선택과 제품 특성 관점에서 NoSQL을 설명하는 문서**입니다.  
시스템 설계 면접에서 "왜 이 서비스에 NoSQL을 선택하는가"라는 의사결정 흐름은 [데이터베이스 설계](../system-design/database-design.md) 문서와 함께 보면 더 자연스럽습니다.
