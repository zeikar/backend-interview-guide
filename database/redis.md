...
레디스는 "빠른 캐시"로만 소개하기보다, 자료구조 중심으로 다양한 문제를 풀 수 있는 저장소라는 점까지 같이 설명하는 편이 좋습니다.
...
그래서 Redis 트랜잭션을 설명할 때는 이렇게 말하는 편이 정확합니다.
...
- **Redis는 인메모리 캐시가 아니라 데이터 구조 저장소로 설명하는 편이 더 정확합니다.**
