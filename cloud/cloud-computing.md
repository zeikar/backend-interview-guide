...
- 클라우드 서비스는 일반적으로 여러 가용 영역과 데이터 센터에 걸친 복제, 백업, failover 구성을 통해 높은 가용성과 재해 복구 전략을 설계할 수 있도록 지원합니다.
...
- 클라우드 제공자가 제공하는 표준 인스턴스나 리소스 크기는 특정 비즈니스 요구에 딱 맞지 않을 수 있으며, 세부적인 하드웨어 제어가 필요한 워크로드에서는 제약이 있을 수 있습니다.
